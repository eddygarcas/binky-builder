# Binky::Builder ![Travis](https://travis-ci.org/eddygarcas/binky-builder.svg?branch=master) [![RubyGems](https://badgen.net/rubygems/v/binky-builder)](https://rubygems.org/gems/binky-builder)
